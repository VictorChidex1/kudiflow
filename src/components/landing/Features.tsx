...
export function Features() {
  return (
    <section className="py-24 bg-gradient-to-b from-kudi-bg to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-2 text-4xl leading-tight font-extrabold tracking-tight text-kudi-dark sm:text-5xl">
            Everything you need,
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-kudi-green to-emerald-400">
              even when offline.
            </span>
          </p>
        ...
        >
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-kudi-green to-emerald-400 rounded-2xl blur opacity-0 group-hover:opacity-20 transition duration-500" />
                <div className="relative h-full bg-white/80 backdrop-blur-md rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:border-kudi-green/30 transition-all duration-300 flex flex-col items-start">
                  <div className="inline-flex items-center justify-center p-3.5 bg-kudi-bg rounded-xl text-kudi-green mb-6 group-hover:bg-kudi-green group-hover:text-white transition-colors duration-300 shadow-sm">
